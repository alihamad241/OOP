...
public class AddSquare extends javax.swing.JFrame {
     ...
     * @param jComboBox1
     */
    public AddSquare(DrawingCanvas drawingCanvas, JComboBox<String> jComboBox1) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String side = jTextField2.getText().trim();

        if(Validation.validatePosition(position, drawingCanvas) && Validation.validateNumber(side)){
